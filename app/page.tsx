  ...
  return (
    <div style={{
          ...
          <AnimatedSection>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {[
                ...
                { text: "Founding member status and community access", color: "#5CE0B8" },
                { text: "Priority support and 1-on-1 onboarding", color: "#5CE0B8" },
              ].map((item, i) => (
                <div key={i} style={{ display: "flex", gap: 12, alignItems: "center" }}>
                  <div style={{ width: 6, height: 6, background: item.color, borderRadius: "1px", flexShrink: 0 }} />
                  <div style={{ fontSize: "12px", color: item.color }}>{item.text}</div>
                </div>
              ))}
            </div>
          </AnimatedSection>
      ...
      <div style={{
        ...
        <AnimatedSection>
          <div style={{ fontSize: "9px", color: "#E05C5C", letterSpacing: "4px", marginBottom: 24 }}>READY TO UPGRADE YOUR TRADING?</div>
          <div style={{ fontSize: "clamp(18px, 3vw, 24px)", lineHeight: 1.4, marginBottom: 32 }}>
            Founder Access is limited to 100 traders.
          </div>
          <a href={GUMROAD} target="_blank" rel="noopener noreferrer" style={{
            background: "#C8A84B", color: "#000",
